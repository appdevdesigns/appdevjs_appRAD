...
//steal('/appRAD/portal/view/appdevListAdmin.ejs').then(function() {
    ...
    (function() {
        ...
        AD.Controller.extend('appdevListAdmin', {
            ...
            init: function (el, options) {
                ...
                var defaults = {
/*
                      gid:'appdevListAdmin_uuid_notGiven',
...
modelInstance:null,  // {object} a provided instance of the model to be used to operate the Add Form
                ...
                //// store a copy of this obj in $(element).data('appdevListAdmin');
 ...
 //               $li.click(function(ev){ self.onSelect(ev); });
            ...
            insertDOM: function() {
                ...
                this.element.html(this.view('/appRAD/portal/view/appdevListAdmin.ejs', {titleKey:'[appRad.portal.model.list.title]'}));
...
/*
                this.addForm.bind('canceled', function(event, model) {

                    self.onCancel(event, model);
                });
*/

//                this.addForm.find('#add-form-btn-submit').click(function(){self.onAddSubmit();});
//                this.addForm.find('#add-form-btn-cancel').click(function(){self.onAddCancel();});
                this.addForm.hide();
 ...
 //                       buttonList.append(' ');
   ...
   //             this.element.find('.adminlist-entry').selectable();
            },
            ...
            onAdd: function() {
                ...
                if (this.options.onAdd) {
                    ...
                    if ('undefined' == typeof defaultAction) defaultAction = false; // they should specifically return false
                }
